...
g= datetime.datetime(2024, 1,20 , 12, 00 ,0)

# if (x.strftime("%x"))>(g.strftime("%x")):
 # print('\n\n')
 # print("     "+' انتهئ التفعيل انضم للقناه للحصول ع احدث نسخه نومرسي المطور🖤') 
 # print('\n\n')
 # print(x)
...
# if (x.strftime("%x"))==(g.strftime("%x")):
   ...
   # if(x.strftime("%X"))>(g.strftime("%X")):
    # print('\n\n')
    # print("     "+' انتهت الصلاحيه عليك بمراسلت المطور  يفعلك  نومرسي المطور🖤') 
    # print('\n\n')
    # print(x)
...
• DeCoDe By @X5_PRO1 •
————————————————
{B}« {C}نومرسي تاج راسك  {B}»
{P}┏{B}━━━━━━━━━━━━━━━━━━━━━━━━━━{P}┓    
{B}┃{C} ⌯ Telegram {B}› {C} يوزري By @X5_PRO1 {B} 	┃
{P}┗{B}━━━━━━━━━━━━━━━━━━━━━━━━━━{P}┛   
""")
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [نومرسي مطور] %s/%s •‿- [OK] %s •‿- [CP] %s •‿- %s%s%s'%  (bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
